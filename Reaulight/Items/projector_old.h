#ifndef PROJECTOR_OLD_H
#define PROJECTOR_OLD_H
...
class Projector_old : public QObject
{
    Q_OBJECT
    ...
    public:
        ...
        Projector_old(QVector3D pos, int adress, double distance_attache_rotation, double angle, QObject *parent=nullptr);
